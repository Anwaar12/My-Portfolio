...
> In this project I make a portfolio copying design from Figma "Template 1". In HTML file I make form for email, username , button.In CSS file I style this forms and also place bakground image on page .I also add linter files to check for linter errors and then created a github pull request by following github flow.
